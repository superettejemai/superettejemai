    ...
    <div className="min-h-screen bg-white px-5">
      ...
      <div className="mb-6">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4">
          ...
          <button
            className="flex items-center gap-2 px-4 py-4 bg-gray-600 text-white text-sm hover:bg-gray-700 transition-colors mt-4 lg:mt-0 border border-gray-300 font-medium focus:ring-1 focus:ring-gray-400 disabled:bg-gray-400 disabled:cursor-not-allowed"
                    ...
                    <div className="flex flex-col items-center justify-center text-gray-500">
                      ...
                      {!isWorker && (
                        <button
                          ...
                          className="px-3 py-2 bg-gray-600 text-white text-sm hover:bg-gray-700 transition-colors border border-gray-300 focus:ring-1 focus:ring-gray-400"
                        >
                          Ajouter un produit
                        </button>
                      )}
