...
export default function FactureManagementPage() {
  ...
  const fetchFactures = async (searchTerm: string = searchQuery) => {
    try {
      ...
      let url = `https://superettejemai.onrender.com/api/factures?`;
  ...
  const searchProducts = async (query: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://superettejemai.onrender.com/api/products?q=${encodeURIComponent(
          query
        )}&limit=10`,
        {
          headers: {
  ...
  const createFacture = async () => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch("https://superettejemai.onrender.com/api/factures", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const confirmFacture = async (factureId: number) => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `https://superettejemai.onrender.com/api/factures/${factureId}/confirm`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const cancelFacture = async (factureId: number) => {
    ...
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `https://superettejemai.onrender.com/api/factures/${factureId}/cancel`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
          ...
          <div className="bg-white p-4 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-medium text-gray-600">Confirmées</p>
                ...
                <tr>
                  <td colSpan={6} className="px-4 py-8 text-center">
                    <div className="flex flex-col items-center justify-center text-gray-500">
                      <BsFileEarmarkText className="w-8 h-8 mb-2 text-gray-300" />
