...
const EditProductPage: React.FC = () => {
  ...
  const fetchAvailableCategories = async () => {
    try {
      ...
      const response = await fetch("https://superettejemai.onrender.com/api/products", {
        method: "GET",
        headers: {
  ...
  const fetchProductData = async () => {
    try {
      ...
      const response = await fetch(
        `https://superettejemai.onrender.com/api/products/${productId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (productData.ProductImages && productData.ProductImages.length > 0) {
        ...
        const imageUrl = `https://superettejemai.onrender.com${primaryImage.url}`;
