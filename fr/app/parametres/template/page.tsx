...
export default function ReceiptTemplateEditor() {
  ...
  const loadCurrentTemplate = async () => {
    try {
      ...
      const response = await fetch('https://superettejemai.onrender.com/api/templates/current', {
        method: 'GET',
        headers: {
      ...
      if (response.ok) {
        ...
        if (template.logo_url) {
          ...
          setExistingLogoPath(`https://superettejemai.onrender.com/${template.logo_path}`);
        }
  ...
  const handleSaveTemplate = async () => {
    try {
      ...
      const response = await fetch('https://superettejemai.onrender.com/api/templates', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
